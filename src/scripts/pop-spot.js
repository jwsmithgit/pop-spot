...
export async function execute(accessToken) {
    ...
    console.log('undedinged album albums ' + JSON.stringify(likedAlbums.some(album => !album.artistIds)));
    ...
    console.log('undedinged track albums ' + JSON.stringify(trackAlbums.some(album => !album.artistIds)));
    likedAlbums = likedAlbums.concat(trackAlbums);
    console.log('undedinged trackalbum albums ' + JSON.stringify(likedAlbums.some(album => !album.artistIds)));
